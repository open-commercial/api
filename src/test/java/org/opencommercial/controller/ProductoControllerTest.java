...
import org.opencommercial.model.dto.CantidadEnSucursalDTO;
import org.opencommercial.model.dto.ProductoDTO;
...
class ProductoControllerTest {
  ...
  void shouldActualizarProducto() {
    ...
    var cantidadEnSucursalDTO = CantidadEnSucursalDTO.builder().idSucursal(1L).cantidad(BigDecimal.TEN).build();
    ...
    when(modelMapper.map(cantidadEnSucursalDTO, CantidadEnSucursal.class)).thenReturn(cantidadEnSucursal);
