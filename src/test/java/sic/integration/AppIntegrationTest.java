...
class AppIntegrationTest {
  ...
  private void crearDosProductos(String descripcionUno, BigDecimal porcentajePrecioBonificadoUno, String descripcionDos, BigDecimal porcentajePrecioBonificadoDos) {
  ...
  private void crearFacturaTipoADePedido() {
    RenglonFactura[] renglonesParaFacturar =
      restTemplate.getForObject(
        apiPrefix
          + "/facturas/ventas/renglones/pedidos/1"
          + "?tipoDeComprobante="
          + TipoDeComprobante.FACTURA_A,
        RenglonFactura[].class);
    List<NuevoRenglonFacturaDTO> nuevosRenglones = new ArrayList<>();
    NuevoRenglonFacturaDTO nuevoRenglon = NuevoRenglonFacturaDTO.builder()
            //.bonificacion(renglonesParaFacturar[0].getBonificacionPorcentaje())
            .cantidad(renglonesParaFacturar[0].getCantidad())
            .idProducto(renglonesParaFacturar[0].getIdProductoItem())
            .build();
    nuevosRenglones.add(nuevoRenglon);
    Long[] idsFormasDePago = {1L};
    BigDecimal[] montos = {new BigDecimal("5324.000000000000000")};
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
        NuevaFacturaVentaDTO.builder()
            .idCliente(1L)
            .idSucursal(1L)
            .idTransportista(1L)
            .observaciones("Factura A del Pedido")
            ...
            .build();
    this.abrirCaja();
    restTemplate.postForObject(apiPrefix + "/facturas/ventas", nuevaFacturaVentaDTO, sic.model.FacturaVenta[].class);
  }
  ...
  private void crearFacturaTipoBDePedido() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .build();
    restTemplate.postForObject(
        apiPrefix + "/facturas/ventas", nuevaFacturaVentaDTO, sic.modelo.FacturaVenta[].class);
  }
  ...
  void shouldCrearFacturaVentaAndDividirlas() {
    this.crearDosProductos(
        RandomStringUtils.random(10, false, true), new BigDecimal("20"),
        RandomStringUtils.random(10, false, true), new BigDecimal("20"));
    ...
    NuevoRenglonFacturaDTO nuevoRenglon = NuevoRenglonFacturaDTO.builder()
            ...
            .build();
    nuevosRenglones.add(nuevoRenglon);
    nuevoRenglon = NuevoRenglonFacturaDTO.builder()
  ...
  void shouldCrearFacturaVentaASucursal1() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .observaciones("Factura Venta A test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_A)
                    .renglones(nuevosRenglones)
  ...
  void shouldEmitirReporteFactura() {
    ...
    restTemplate.getForObject(apiPrefix + "/facturas/ventas/1/reporte", byte[].class);
  }
  ...
  void shouldCrearFacturaVentaB() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Venta B test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_B)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
                    .fechaVencimiento(LocalDate.now().plusYears(1L))
                    .build();
    Cliente cliente = restTemplate.getForObject(apiPrefix + "/clientes/1", Cliente.class);
    Transportista transportista =
      restTemplate.getForObject(apiPrefix + "/transportistas/1", Transportista.class);
  ...
  void shouldNotModificarFacturaSiElClienteSeModifica() {
    ...
    FacturaVenta facturaVenta =
        restTemplate
            .postForObject(
                apiPrefix + "/facturas/ventas", nuevaFacturaVentaDTO, FacturaVenta[].class)[0];
  ...
  void shouldCrearFacturaVentaC() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Venta C test")
  ...
  void shouldCrearFacturaVentaX() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Venta X test")
  ...
  @Test
  void shouldNotCrearFacturaVentaY() {
    this.crearDosProductos(
        RandomStringUtils.random(10, false, true),
        BigDecimal.ZERO,
        RandomStringUtils.random(10, false, true),
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Venta Y test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_Y)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
                    .build();
  ...
  void shouldCrearFacturaVentaPresupuesto() {
    ...
    NuevaFacturaVentaDTO nuevaFacturaVentaDTO =
            NuevaFacturaVentaDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Venta Presupuesto test")
  ...
  void shouldCrearFacturaBCompraSucursal1() {
    ...
    NuevaFacturaCompraDTO nuevaFacturaCompraDTO =
            NuevaFacturaCompraDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Compra B test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_B)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
  ...
  void shouldCrearFacturaCompraC() {
    ...
    NuevaFacturaCompraDTO nuevaFacturaCompraDTO =
            NuevaFacturaCompraDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Compra C test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_C)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
  ...
  void shouldCrearFacturaCompraX() {
    ...
    NuevaFacturaCompraDTO nuevaFacturaCompraDTO =
            NuevaFacturaCompraDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Compra X test")
                    .tipoDeComprobante(TipoDeComprobante.FACTURA_X)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
  ...
  void shouldCrearFacturaCompraPresupuesto() {
    ...
    NuevaFacturaCompraDTO nuevaFacturaCompraDTO =
            NuevaFacturaCompraDTO.builder()
                    ...
                    .idSucursal(1L)
                    .idTransportista(1L)
                    .observaciones("Factura Compra Presupuesto test")
                    .tipoDeComprobante(TipoDeComprobante.PRESUPUESTO)
                    .renglones(nuevosRenglones)
                    .recargoPorcentaje(BigDecimal.TEN)
                    .descuentoPorcentaje(new BigDecimal("25"))
  ...
  void shouldCrearNotaCreditoVentaDeFacturaASucursal1() {
    ...
    List<FacturaVenta> facturasRecuperadas =
        restTemplate
            .exchange(
                apiPrefix
                    + "/facturas/ventas/busqueda/criteria",
                HttpMethod.POST,
                requestEntity,
                new ParameterizedTypeReference<PaginaRespuestaRest<FacturaVenta>>() {})
            .getBody()
  ...
  void shouldNotCrearPedidoSinUbicacionSucursal() {
    ...
    RestClientResponseException thrown =
        assertThrows(
            ...
            () ->
                restTemplate.postForObject(
                    apiPrefix + "/pedidos", pedidoDTO, Pedido.class));
    assertNotNull(thrown.getMessage());
    assertTrue(
        thrown
            .getMessage()
  ...
  void shouldFacturarPedido() {
    ...
    Pedido pedidoRecuperado =
      restTemplate.getForObject(apiPrefix + "/pedidos/1", Pedido.class);
    pedidoRecuperado =
      restTemplate.getForObject(
        apiPrefix + "/pedidos/" + pedidoRecuperado.getIdPedido(), Pedido.class);
  ...
  void shouldModificarPedido() {
    ...
    Pedido pedidoRecuperado =
      restTemplate.postForObject(
        ...
        Pedido.class);
    assertEquals(new BigDecimal("5947.200000000000000"), pedidoRecuperado.getTotalEstimado());
    assertEquals(pedidoDTO.getObservaciones(), pedidoRecuperado.getObservaciones());
    assertEquals(EstadoPedido.ABIERTO, pedidoRecuperado.getEstado());
    this.crearDosProductos(
            RandomStringUtils.random(10, false, true),
            new BigDecimal("20"),
    ...
    nuevosRenglonesDePedido.add(
        NuevoRenglonPedidoDTO.builder()
            .idProductoItem(renglones.get(0).getIdProductoItem())
            .cantidad(renglones.get(0).getCantidad())
            .build());
    nuevosRenglonesDePedido.add(
    NuevoRenglonPedidoDTO.builder()
        .idProductoItem(3)
        ...
        .build());
    PedidoDTO detallePedidoParaModificar = PedidoDTO.builder()
    ...
    assertEquals(new BigDecimal("9873.600000000000000"), pedidoModificado.getTotalEstimado());
  ...
  void shloudVerificarCantidadDeArticulosEnPedido() {
    this.shouldCrearPedido();
    Pedido pedidoDTO = restTemplate.getForObject(apiPrefix + "/pedidos/1", Pedido.class);
  ...
  void shouldVerificarTotalActualPedido() {
    this.shouldCrearPedido();
    Pedido pedido = restTemplate.getForObject(apiPrefix + "/pedidos/1", Pedido.class);
    assertEquals(new BigDecimal("7.000000000000000"), pedido.getCantidadArticulos());
    assertEquals(new BigDecimal("5947.200000000000000"), pedido.getTotalEstimado());
  ...
  void shouldGetMultiplesProductosPorIdEnOrden() {
    ...
    List<sic.modelo.RenglonPedido> renglones = pedidoService.getRenglonesDelPedidoOrdenadorPorIdRenglon(1L);
  ...
  void shouldVerificarTotalizadoresVenta() {
    ...
    BigDecimal totalFacturadoVenta =
      restTemplate.postForObject(
        apiPrefix + "/facturas/ventas/total-facturado/criteria", criteria, BigDecimal.class);
    BigDecimal totalIvaVenta =
      restTemplate.postForObject(
        apiPrefix + "/facturas/ventas/total-iva/criteria", criteria, BigDecimal.class);
    BigDecimal gananciaTotal =
      restTemplate.postForObject(
        apiPrefix + "/facturas/ventas/ganancia-total/criteria", criteria, BigDecimal.class);
  ...
  void shouldVerificarTotalizadoresCompra() {
    ...
    BigDecimal totalFacturadoCompra =
        restTemplate.postForObject(
            apiPrefix + "/facturas/compras/total-facturado/criteria", criteria, BigDecimal.class);
    BigDecimal totalIvaCompra =
        restTemplate.postForObject(
            apiPrefix + "/facturas/compras/total-iva/criteria", criteria, BigDecimal.class);
    ...
    paginaRespuestaRest =
        restTemplate
            .exchange(
                ...
                new ParameterizedTypeReference<PaginaRespuestaRest<ProductoDTO>>() {})
            .getBody();
    assertNotNull(paginaRespuestaRest);//asd
  ...
  void shouldCrearReporteListaPrecios() {
    this.crearDosProductos("1er Producto", BigDecimal.ZERO, "2do Producto", BigDecimal.ZERO);
    BusquedaProductoCriteria criteria = BusquedaProductoCriteria.builder().pagina(0).build();
    HttpEntity<BusquedaProductoCriteria> requestEntity = new HttpEntity<>(criteria);
    restTemplate
        .exchange(
  ...
  void shouldCrearProductosEnTresSucursales(){
    this.crearDosProductos("A", BigDecimal.ZERO, "B", BigDecimal.ZERO);
    BusquedaProductoCriteria criteria = BusquedaProductoCriteria.builder().pagina(0).build();
    HttpEntity<BusquedaProductoCriteria> requestEntity = new HttpEntity<>(criteria);
    PaginaRespuestaRest<ProductoDTO> paginaRespuestaRest =
      restTemplate
  ...
  void shouldNotEnviarEmailDeFacturaSiLaFacturaNoTieneCae() {
    ...
    RestClientResponseException thrown =
      assertThrows(
        RestClientResponseException.class,
        () ->  restTemplate.getForObject(apiPrefix + "/facturas/ventas/email/1", Object.class));
    assertNotNull(thrown.getMessage());
    assertTrue(
      thrown
        .getMessage()
