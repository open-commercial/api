...
INSERT INTO empresa (`categoriaIva`, `eliminada`, `email`, `fecha_inicio_actividad`, `id_fiscal`, `ingresos_brutos`, `lema`, `logo`, `nombre`, `telefono`, `id_ubicacion`)
VALUES ('RESPONSABLE_INSCRIPTO',false,'support@globocorporation.com','2012-08-08 00:00:00',23154587589,123456789,'testeando',NULL,'Globo Corporation','3794551122',5);

INSERT INTO usuario (`apellido`, `eliminado`, `email`, `habilitado`, `id_empresa_predeterminada`, `nombre`, `password`, `password_recovery_key`,
`password_recovery_key_expiration_date`, `token`, `username`)
VALUES ('test',false,'test@test.com',true,1,'Empresa Test','098f6bcd4621d373cade4e832627b4f6','',NULL,'','test'),
...
INSERT INTO proveedor(categoriaIva, contacto, eliminado, email, id_fiscal, razon_social, tel_primario, tel_secundario, web, id_Empresa, id_ubicacion, nro_proveedor)
VALUES ('RESPONSABLE_INSCRIPTO','Raul Gamez',false,'chamacosrl@gmail.com',23127895679,'Chamaco S.R.L.','3794356778', '123456','www.chamacosrl.com.ar',1,4,1);

INSERT INTO rubro(eliminado, nombre, id_Empresa)
VALUES (false,'Ferreteria',1);

INSERT INTO configuraciondelsistema(cantidad_maxima_de_renglones_en_factura, certificado_afip, email_password, email_sender_habilitado, email_username,
factura_electronica_habilitada, fecha_generacion_tokenWsaa, fecha_vencimiento_tokenWsaa, firmante_certificado_afip,
nro_punto_de_venta_afip, password_certificado_afip, sign_tokenWsaa, tokenWsaa, usar_factura_venta_pre_impresa, id_Empresa)
VALUES (3000,NULL,NULL,false,NULL,false,NULL,NULL,NULL,1,NULL,NULL,NULL,false,1);

INSERT INTO cuentacorriente(eliminada,fecha_apertura, id_empresa, saldo, fecha_ultimo_movimiento)
