INSERT INTO test.provincia(nombre)
VALUES ('Corrientes'),('Misiones'),('Chaco');

INSERT INTO test.localidad(codigo_postal, costo_envio, envio_gratuito, nombre, id_provincia)
...
INSERT INTO test.formadepago(afecta_caja, eliminada, nombre, predeterminado)
VALUES (true,false,'Efectivo',true),
       (false,false, 'Cheque de 3ros',false);

INSERT INTO test.usuario(apellido, eliminado, email, habilitado, id_sucursal_predeterminada, nombre,
...
INSERT INTO test.rol(id_usuario, nombre)
