...
import org.opencommercial.model.criteria.BusquedaNotaCriteria;
import org.opencommercial.model.dto.NuevaNotaCreditoDeFacturaDTO;
...
import org.opencommercial.repository.NotaCreditoRepository;
import org.opencommercial.repository.NotaDebitoRepository;
import org.opencommercial.repository.NotaRepository;
    ...
    if (nuevaNotaDebitoSinReciboDTO.getTipoDeComprobante() != null) {
      if (nuevaNotaDebitoSinReciboDTO.getIdCliente() != null) {
        ...
        if (nuevaNotaDebitoSinReciboDTO.getDetalleCompra() != null) {
          ...
          notaDebitoCalculada.setNroNota(nuevaNotaDebitoSinReciboDTO.getDetalleCompra().getNroNota());
          notaDebitoCalculada.setCae(nuevaNotaDebitoSinReciboDTO.getDetalleCompra().getCae());
        }
      }
    } else {
      throw new BusinessServiceException(
