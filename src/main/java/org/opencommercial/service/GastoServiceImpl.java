...
public class GastoServiceImpl implements GastoService {
  ...
  public BooleanBuilder getBuilder(BusquedaGastoCriteria criteria) {
    ...
    if (criteria.getNroGasto() != null)
      builder.and(qGasto.nroGasto.eq(criteria.getNroGasto()));
    if (criteria.getIdUsuario() != null)
      builder.and(qGasto.usuario.idUsuario.eq(criteria.getIdUsuario()));
    if (criteria.getIdSucursal() != null) {
      builder.and(qGasto.sucursal.idSucursal.eq(criteria.getIdSucursal()).and(qGasto.eliminado.eq(false)));
    }
    return builder;
  }
