...
public class NotaServiceImpl implements INotaService {
  ...
  public void eliminarNota(long idNota) {
    ...
    log.warn("La Nota {} se eliminó correctamente.", nota);
  }
  ...
  public NotaCredito guardarNotaCredito(NotaCredito notaCredito) {
    ...
    log.warn("La Nota de Credito {} se guardó correctamente.", notaCredito);
    return notaCredito;
  }
  ...
  public NotaDebito guardarNotaDebito(NotaDebito notaDebito) {
    ...
    log.warn("La Nota de Debito {} se guardó correctamente.", notaDebito);
    return notaDebito;
  }
