...
select cliente.nroCliente, cliente.nombreFiscal, cliente.nombreFantasia, SUM(factura.total) as totalFacturas from factura inner join facturaventa on factura.id_Factura = facturaventa.id_Factura
