...
) ENGINE=InnoDB AUTO_INCREMENT=21644 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notacredito` (
  ...
  `modificaStock` bit(1) DEFAULT NULL,
  PRIMARY KEY (`idNota`),
...
) ENGINE=InnoDB AUTO_INCREMENT=33246 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6219 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4198 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rengloncuentacorriente` (
  ...
  `comprobante` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `monto` double NOT NULL,
  `tipoMovimiento` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_Factura` bigint(20) DEFAULT NULL,
  `idNota` bigint(20) DEFAULT NULL,
  ...
  KEY `FKtetmeccbtu8smdr7pryjw1dor` (`id_Pago`),
  ...
  CONSTRAINT `FKtetmeccbtu8smdr7pryjw1dor` FOREIGN KEY (`id_Pago`) REFERENCES `pago` (`id_Pago`)
) ENGINE=InnoDB AUTO_INCREMENT=54529 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=249441 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=104193 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-06 11:28:21
