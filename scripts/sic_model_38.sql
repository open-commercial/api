CREATE DATABASE  IF NOT EXISTS `ykcojs0liv7ir9od` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `ykcojs0liv7ir9od`;
...
CREATE TABLE `caja` (
  ...
  `saldoApertura` decimal(25,15) DEFAULT NULL,
  `saldoReal` decimal(25,15) DEFAULT NULL,
  `saldoSistema` decimal(25,15) DEFAULT NULL,
...
CREATE TABLE `configuraciondelsistema` (
  ...
  `emailSenderHabilitado` bit(1) NOT NULL,
  `emailUsername` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `facturaElectronicaHabilitada` bit(1) NOT NULL,
  `fechaGeneracionTokenWSAA` datetime DEFAULT NULL,
  `fechaVencimientoTokenWSAA` datetime DEFAULT NULL,
  ...
  `signTokenWSAA` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tokenWSAA` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `factura` (
  ...
  KEY `FKshbrt6t14ysy6skp8tcjjeybl` (`id_Usuario`),
  ...
  CONSTRAINT `FKshbrt6t14ysy6skp8tcjjeybl` FOREIGN KEY (`id_Usuario`) REFERENCES `usuario` (`id_Usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nota` (
  ...
  `id_Cliente` bigint(20) DEFAULT NULL,
  `id_Empresa` bigint(20) DEFAULT NULL,
  `id_FacturaCompra` bigint(20) DEFAULT NULL,
  `id_FacturaVenta` bigint(20) DEFAULT NULL,
  `id_Proveedor` bigint(20) DEFAULT NULL,
  `id_Usuario` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`idNota`),
  KEY `FK575rh35j0t8t085cwngtu9688` (`id_Cliente`),
  KEY `FKnt9tgtl6tq8pe0eq2o835lecb` (`id_Empresa`),
  KEY `FKb0hlmuic7ga80uslqpmu8srw` (`id_FacturaCompra`),
  KEY `FK99nl3v9fq5yh7us0tfvbsc7yd` (`id_FacturaVenta`),
  KEY `FK2td4jaq62jlok3w6p6dgnrtgb` (`id_Proveedor`),
  KEY `FK3tyjyayu04yehvuohrj8u9ult` (`id_Usuario`),
  CONSTRAINT `FK2td4jaq62jlok3w6p6dgnrtgb` FOREIGN KEY (`id_Proveedor`) REFERENCES `proveedor` (`id_Proveedor`),
  ...
  CONSTRAINT `FK99nl3v9fq5yh7us0tfvbsc7yd` FOREIGN KEY (`id_FacturaVenta`) REFERENCES `facturaventa` (`id_Factura`),
  CONSTRAINT `FKb0hlmuic7ga80uslqpmu8srw` FOREIGN KEY (`id_FacturaCompra`) REFERENCES `facturacompra` (`id_Factura`),
...
CREATE TABLE `producto` (
  ...
  `impuestoInternoNeto` decimal(25,15) DEFAULT NULL,
  `impuestoInternoPorcentaje` decimal(25,15) DEFAULT NULL,
...
CREATE TABLE `usuario` (
  ...
  `idEmpresaPredeterminada` bigint(20) NOT NULL,
  `nombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `passwordRecoveryKey` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `passwordRecoveryKeyExpirationDate` datetime DEFAULT NULL,
...
-- Dump completed on 2018-09-21 19:02:26
